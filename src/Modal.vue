                ...
                >
                    ...
                    >
                        <div class="v--modal-content">
                            <div class="v--modal-header" v-if="hasHeaderSlot">
                                <slot name="header"/>
                                <button type="button" class="close" aria-label="Close" @click="closeModal" v-if="closeButton">
                            ...
                            <div class="v--modal-footer" v-if="hasFooterSlot">
                                <slot name="footer"/>
                            </div>
                        </div>
                        <resizer
...
<script>
    ...
    import { blurActiveElement, createModalEvent, getMutationObserver, inRange } from './utils'
